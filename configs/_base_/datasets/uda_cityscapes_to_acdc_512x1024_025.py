...
data = dict(
    ...
    train=dict(
        ...
        source=dict(
            ...
            img_dir='leftImg8bit/train_25', # NOTE: modify this one
            ann_dir='gtFine/train_25', # NOTE: modify this one
            pipeline=cityscapes_train_pipeline),
        target=dict(
            type='ACDCDataset',
            data_root=f'{root}/acdc/', 
    ...
    val=dict(
        type='CityscapesDataset',
        data_root=f'{root}/cityscapes/',
        img_dir='leftImg8bit/val', # NOTE: modify this one
        ann_dir='gtFine/val', # NOTE: modify this one
