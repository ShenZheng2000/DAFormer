...
img_scale = (1024, 512)
# img_scale = (2048, 1024) # NOTE: hardcode as full cs shape now
# img_scale = (1536, 768) # NOTE: hardcode as 3/4 shape for now
...
data = dict(
    # samples_per_gpu=2,
    samples_per_gpu=1, # NOTE: reduce batch size to fit on GPU
    workers_per_gpu=4,
    train=dict(
        type='UDADataset',
        source=dict(
