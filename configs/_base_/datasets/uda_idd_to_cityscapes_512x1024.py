...
# img_scale = (960, 540) # NOTE: half of most idd image (tink about a better way to do this!)
img_scale = (1024, 512) # NOTE: half of most idd image (tink about a better way to do this!)
idd_train_pipeline = [
...
data = dict(
    ...
    train=dict(
        ...
        source=dict(
            type='IDDDataset',
            data_root=f'{root}/IDD/IDD_Segmentation/',
